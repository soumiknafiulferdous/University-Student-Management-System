  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('student_dashboard')}}"><img src="{{URL::asset('images/nogor_logo.svg')}}" alt="Logo"></a>
      </div>
        ...
        <ul class="navbar-nav ml-lg-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown mail-notification" aria-labelledby="MailDropdown">
              <a class="dropdown-item" href="{{URL::to('about_profile')}}">
                <div class="sender-img">
                  <img src="{{URL::asset('images/nogor3.jpg')}}" alt="">
                  <span class="badge badge-success">&nbsp;</span>
                </div>
                <div class="sender">
                  <p class="Sende-name">About NSL</p>
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        @php 
               ...
               $student_info=DB::table('student_tbl')->where('student_email',$student_email)->first();
        @endphp
